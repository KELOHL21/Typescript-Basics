...
// Form
const form = document.querySelector('.new_items') as HTMLFormElement;

// List template
const ul = document.querySelector('.item_list') as HTMLUListElement;
...
form.addEventListener('submit', (e:Event)=>{
   ...
   let doc:Formatter; //Has to be structured/or include whatever is in Interface file ie. - Formatter
